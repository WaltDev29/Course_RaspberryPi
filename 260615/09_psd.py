...
class MainFrame(Frame):
    ...
    def __init__(self, master):
        ...
        master.title('PSD Sensor Monitoring')
        ...
        self.value.set("PSD : {} cm".format(0))

        # PSD 센서의 상태를 표시할 Label
        self.psd_label = Label(
            master,
            background="yellow",
    ...
    def analogReadThread(self):
        ...
        try:
            ...
            while True:
                ...
                # PSD 센서는 4번 채널(A3)
                # ADC 입력 전압 계산
                voltage = adc_data[4] / 255.0 * 3.3

                # 전압 분배 전의 전압 계산
                voltage = voltage * 3 / 2

                # 거리 계산
                psd_value = 29.988 * math.pow(
                    voltage,
                    -1.173
                )
